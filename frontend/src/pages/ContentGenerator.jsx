...
function ContentGenerator(){
  ...
  const [formatTab,setFormatTab] = useState('both')
  ...
  const generate = ()=>{
    ...
    setTimeout(()=>{
      ...
      setResult({
        hook:"Stop scrolling! This will change your content strategy.",
        angle:"Teach creators a trick most people ignore.",
        outline:[
        ...
        caption:"Most creators miss this simple trick.\nTry it in your next post.",
        tip:"Post consistently at the same time each day."
      })
    ...
    <div style={{display:'flex',gap:'6px'}}>
      ...
      <button
        ...
        style={{
          ...
          borderRadius:'6px',
          border:'1px solid var(--border)',
          background:formatTab==='instagram'
            ?'rgba(193,53,132,0.1)'
            :'var(--card)',
          color:formatTab==='instagram'
            ?'#c13584'
            :'var(--dim)',
          cursor:'pointer',
          fontSize:'12px'
      ...
      <button
        onClick={()=>setFormatTab('youtube')}
        style={{
          flex:1,
          padding:'9px 0',
          borderRadius:'6px',
          border:'1px solid var(--border)',
          background:formatTab==='youtube'
            ?'rgba(255,0,0,0.1)'
            :'var(--card)',
          color:formatTab==='youtube'
            ?'#ff4444'
            :'var(--dim)',
          cursor:'pointer',
          fontSize:'12px'
        ...
        <div>
          ...
          {result && (
            ...
            <div style={{
              ...
              <ResultBlock label="Hook">
                {result.hook}
              </ResultBlock>

              <ResultBlock label="Angle">
                {result.angle}
              </ResultBlock>
