  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div style={{ width: "100%", maxWidth: "400px", background: "var(--card)", border: "1px solid var(--border)", borderRadius: "16px", padding: "32px 28px" }}>
        <h1 style={{ fontSize: "20px", fontWeight: "700", color: "var(--text)", margin: "0 0 4px" }}>Where do you create?</h1>
        ...
        <div style={{ display: "flex", gap: "10px", marginBottom: "10px" }}>
          ...
          <div onClick={() => setSelected("youtube")} style={{
            ...
            <span style={{ fontSize: "13px", fontWeight: "600", color: selected === "youtube" ? "var(--text)" : "var(--muted)" }}>YouTube</span>
          ...
          <div onClick={() => setSelected("instagram")} style={{
            ...
            <span style={{ fontSize: "13px", fontWeight: "600", color: selected === "instagram" ? "var(--text)" : "var(--muted)" }}>Instagram</span>
            <span style={{ fontSize: "11px", color: "var(--dim)", textAlign: "center", lineHeight: "1.4" }}>Reels, posts & growth</span>
          </div>
        </div>
        ...
        <div onClick={() => setSelected("both")} style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
            <span style={{ fontSize: "13px", fontWeight: "600", color: selected === "both" ? "var(--text)" : "var(--muted)" }}>Both platforms</span>
            <span style={{ fontSize: "11px", color: "var(--dim)" }}>One dashboard for everything</span>
          </div>
        </div>

        <button onClick={() => selected && navigate("/dashboard")} disabled={!selected}
          style={{
      ...
      <p style={{ marginTop: "20px", fontSize: "12px", color: "var(--dim)" }}>You can change your platform anytime in settings.</p>
    </div>
  );
}