  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: "16px", padding: "32px 28px", width: "100%", maxWidth: "400px" }}>
        ...
        <button onClick={() => navigate(isLogin ? "/dashboard" : "/select-platform")}
          style={{ width: "100%", marginTop: "16px", background: "var(--accent)", border: "none", borderRadius: "10px", padding: "11px", color: "#fff", fontSize: "14px", fontWeight: "600", cursor: "pointer" }}>
          {isLogin ? "Sign In" : "Sign Up"}
        </button>

        <p style={{ color: "var(--muted)", fontSize: "13px", textAlign: "center", marginTop: "16px" }}>
          {isLogin ? "Don't have an account? " : "Already have an account? "}
          <span onClick={() => setIsLogin(!isLogin)} style={{ color: "var(--accent)", cursor: "pointer", fontWeight: "500" }}>
        ...
        <button onClick={() => navigate("/select-platform")}
          style={{ width: "100%", padding: "11px", background: "transparent", border: "1px solid var(--border2)", borderRadius: "10px", color: "var(--text)", fontSize: "14px", fontWeight: "500", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
      ...
      <p style={{ marginTop: "20px", fontSize: "12px", color: "var(--dim)", textAlign: "center" }}>
